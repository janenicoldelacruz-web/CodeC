...
<div class="max-w-6xl mx-auto p-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        @forelse($facultyMembers ?? [] as $teacher)
            <div class="bg-white rounded-3xl border-2 border-slate-200 p-6 shadow-xs hover:border-[#8b1818]/40 transition flex flex-col justify-between">
                <div>
                    <div class="flex items-center gap-4 mb-4">
                        <div class="w-12 h-12 rounded-2xl bg-[#8b1818] text-white text-sm font-black flex items-center justify-center shrink-0 shadow-sm">
