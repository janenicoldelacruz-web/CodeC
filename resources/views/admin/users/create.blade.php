        ...
        <div class="p-8">
            ...
            >
                ...
                <div class="p-6 border-b border-gray-100">
                    ...
                    <p class="text-sm text-gray-500 mt-1">
                        Select the student's grade, section, and strand (optional for non-students).
                    </p>
                            ...
                            >
                                ...
                                @if(isset($sections))
                                    @foreach($sections as $section)
                                        <option
                                            value="{{ $section->id }}"
                                            {{ old('academic_section_id') == $section->id ? 'selected' : '' }}
                                        >
                ...
                <div class="p-6 flex items-center justify-end gap-3">
                    ...
                    <button
                        type="submit"
                        class="px-5 py-2.5 rounded-xl bg-red-600 hover:bg-red-700 text-white text-sm font-semibold shadow-sm transition"
                    >
                        Add User
                    </button>
                </div>
